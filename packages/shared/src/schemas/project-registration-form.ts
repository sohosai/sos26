...
// 企画者向けに公開するフォーム情報（内部管理フィールドは除外）
export const activeProjectRegistrationFormSchema = projectRegistrationFormSchema
	.pick({
		id: true,
		title: true,
		description: true,
	...
	.extend({ items: z.array(projectRegistrationFormItemSchema) });
